...
<head>
    ...
    <title>Gestión Destinaciones</title>
            ...
            <div class="bg-dark dk" id="wrap">
               ...
               <div id="content">
                    <div class="outer" >
                        <div class="inner bg-light lter">
                            <div class="col-lg-12">
                            <h4 style="text-align:center;">Gestión de las Destinaciones</h4>
                            </div>
                        </div>
                        <!-- /.inner -->
                    </div>
					           ...
					           <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
					                <thead>
					                    <tr>
						                     ...
						                     <th style="text-align:center;width:100px;">Playa</th>
						                     <th style="text-align:center;width:200px;">Opciones</th>
					                ...
					                <tbody>
					                    ...
					                    <tr>
					                        ...
					                        <td style="text-align:center;"><%=per.getWeb()%></td>
					                        <td style="text-align:center;"><%=per.getPlaya()%></td>
					                        <td style="text-align:center;">



						                        <a href="#" class="btn btn-success btn-xs">+Info</a>
						                        &nbsp;&nbsp;
						                        <a href="#" class="btn btn-warning btn-xs">Editar</a>
						                        &nbsp;&nbsp;
						                        <a href="#" class="btn btn-metis-1 btn-xs">Eliminar</a>
						                        </td>
